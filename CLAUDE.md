...
Monthly stock take management app (v0.5.2). Import Pastel inventory → department checklist sign-offs → mobile barcode scanning → variance reconciliation → Pastel adjustment export.
